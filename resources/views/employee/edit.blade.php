...
<div class="container-sm mt-5">
    <form action="{{ route('employees.update',['employee' => $employee->id]) }}" method="POST"  method="POST" enctype="multipart/form-data">
...
<div class="row justify-content-center">
    <div class="p-5 bg-light rounded-3 border col-xl-6">
        ...
        <div class="row">
            ...
            <div class="col-md-6 d-grid">
                <button type="submit" class="btn btn-dark btn-lg mt-3"> Save</button>
            </div>
        </div>
    </div>
</div>
